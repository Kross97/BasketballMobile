      ...
      <ImageBackground
        ...
        <View style={styles.containerForm}>
          <TextInput
            ...
            onChangeText={text => changeValuesForm('userName', text)}
            style={styles.input}
          />
          <TextInput
            placeholder={'Введите логин'}
            onChangeText={text => changeValuesForm('login', text)}
            style={styles.input}
          />
          <TextInput
            placeholder={'Введите пароль'}
            onChangeText={text => changeValuesForm('password', text)}
            style={styles.input}
          />
          <TextInput
            placeholder={'Повторите пароль'}
            onChangeText={text => changeValuesForm('repeatPassword', text)}
            style={styles.input}
          />
          <Button color="#E4163A" title="Sign Up" onPress={submitForm} />
